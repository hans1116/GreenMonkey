...
;(function () {
    ...
    DayPilot.Date = function ($K, $L) {
        ...
        if (Object.defineProperty && !DayPilot.browser.ielt9) {
            ...
            Object.defineProperty(this, "value", {"value": $P, "writable": false, "enumerable": true});
        } else {
            this.ticks = $M;
            this.value = $P;
        }
...
(function () {
    ...
    ;
    var cx = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, $0V = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, $0W, $0X, $0Y = {
        '\b': '\\b',
        '\t': '\\t',
        '\n': '\\n',
        '\f': '\\f',
    ...
    function str($x, $10) {
        var i, k, v, length, $11 = $0W, $12, $P = $10[$x];
...
;(function () {
    ...
    function loadDefaultCss() {
        ...
        $b.add(".calendar_default_rowheader_inner,.calendar_default_cornerright_inner,.calendar_default_corner_inner,.calendar_default_colheader_inner,.calendar_default_alldayheader_inner", "color: #666;background: white;");
        ...
        $b.add(".calendar_default_rowheader_inner", "font-size: 8pt;text-align: right; position: absolute;top: 0px;left: 0px;bottom: 0px;right: 0px;border-right: 1px solid #999;border-bottom: 1px solid #999;");
        ...
        $b.add(".calendar_default_rowheader_minutes", "font-size:10px;vertical-align: super;padding-left: 2px;padding-right: 2px;vertical-align:baseline");
    ...
    DayPilotCalendar.Calendar = function (id) {
        ...
        this.drawTop = function () {
            ...
            console.log(this.getScrollableHeight());
    ...
    (function registerAngularModule() {
        ...
        $1z.directive("daypilotCalendar", function () {
            return {
                "restrict": "E", "template": "<div></div>", "replace": true, "link": function ($1A, element, $1B) {
...
;(function () {
    ...
    (function registerAngularModule() {
        ...
        $0P.directive("daypilotMonth", function () {
            return {
                "restrict": "E", "template": "<div></div>", "replace": true, "link": function ($0Q, element, $0R) {
...
;(function () {
    ...
    function loadDefaultCss() {
        ...
        $a.add(".navigator_default_main", "color: #000000;");
        $a.add(".navigator_default_main *, .navigator_default_main *:before, .navigator_default_main *:after", "box-sizing: content-box;");
        $a.add(".navigator_default_month", "font-family: Tahoma;font-size: 13px;");
        $a.add(".navigator_default_day", "color: black;");
        $a.add(".navigator_default_weekend", "background-color: none;");
        $a.add(".navigator_default_dayheader", "color: black;");
        $a.add(".navigator_default_line", "border-bottom: none;");
        $a.add(".navigator_default_dayother", "color: gray;");
        $a.add(".navigator_default_todaybox", "border: none;");
        $a.add(".navigator_default_select, .navigator_default_weekend.navigator_default_select", "background-image: -webkit-linear-gradient(bottom,#e9faff 0,#f8fdff 100%);border-color: rgba(39,134,223,.4);");
        $a.add(".navigator_default_title, .navigator_default_titleleft, .navigator_default_titleright", 'border-top: none;color: #666;');
